...
function GetAllUsers() {
    $.ajax({
        "url": base_url + "UserManage/getUserrights",
        "method": "GET",
        contentType: JSON,
        headers: {
...
function SubmitData() {
    ...
    $.ajax({
        "url": base_url + "RoleManage/AssignRightsIndividual",
        "method": "POST",
        cache: false,
        contentType: false,
        processData: false,
...
function GetAllRigths(userid) {
    $.ajax({
        "url": base_url + "RoleManage/GetAllRights",
        "method": "GET",
        contentType: JSON,
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
